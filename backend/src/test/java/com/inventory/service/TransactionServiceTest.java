...
public class TransactionServiceTest {
    ...
    void setUp() throws IllegalAccessException, NoSuchFieldException {
        ...
        transactionRequest = new TransactionRequest(1L, 2, 2L, 2L, TransactionStatus.ADMIN_DECIDING, "buy a router", BigDecimal.valueOf(179000), null, null, null);
...
//        BDDMockito.given(transactionRepository.searchTransactions(TransactionType.SALE, TransactionStatus.COMPLETED, null, null, -1L,null, null, PageRequest.of(0, 2, Sort.by(Sort.Direction.DESC, "createdAt")))).willReturn(new PageImpl<>(List.of(transaction)));
...
//    }
    ...
    public void getAllTransactionByMonthAndYear() {
        BDDMockito.given(transactionRepository.findAllByMonthAndYear(10, 2025)).willReturn(List.of(transaction));
...
//        UserDTO userDTO1 = UserDTO.builder().role(UserRole.ADMIN).id(1L).phoneNumber("0927539845").email("test@example.com").build();
//        BDDMockito.given(userService.getCurrentLoggedInUser()).willReturn(userDTO1);
//        BDDMockito.given(transactionRepository.save(any)).willReturn(userDTO1);
